package com.game.dealornodeal.view.user;

import com.game.dealornodeal.Case;
import com.game.dealornodeal.view.GameViewCase;
...
public class GameViewPrompter {
    ...
    public void presentCases(GameViewCase finalCase, GameViewCase chosenCase) {
    ...
    public boolean askToSwap(GameViewCase finalCase, GameViewCase chosenCase) {
